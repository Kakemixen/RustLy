//! This is just a copy from the ash-window src due to dependency issues
//! ash-window depends on raw-window-handle 0.3.4, whereas I want the newer
//! 0.4.2 cus new winit
...
/// its usage, the [`Instance`] this was called on must be dropped later than
/// the resulting [`vk::SurfaceKHR`].
#[allow(dead_code)]
